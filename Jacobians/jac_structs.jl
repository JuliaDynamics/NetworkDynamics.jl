...
struct JacGraphData{JGDB}
    jgdb::JGDB
    v_jac_array::Array{Array{Float, 2}, 1}
...
function network_dynamics(vertices!::Union{Array{T, 1}, T},
    ...
    if jac == true
        ...
        nd_jac_operator = NDJacVecOperator(x, p, t, graph, graph_structure, graph_data, jac_graph_data, parallel) # Problem: x, p, t nicht da
