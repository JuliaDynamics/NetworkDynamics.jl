...
ForwardDiff.jacobian!(pseudo_jac_v, (dv, v) -> pseudo_diffusionvertex!(dv, v, e, p, t), dv, b, cfg1, Val{false}())

cfg11 = ForwardDiff.JacobianConfig((dv, e) -> pseudo_diffusionvertex!(dv, v, e, p, t), dv, c)
ForwardDiff.jacobian!(pseudo_jac_e, (dv, e) -> pseudo_diffusionvertex!(dv, v, e, p, t), dv, c, cfg11, Val{false}())
