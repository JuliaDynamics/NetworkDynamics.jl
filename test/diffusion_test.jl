...
# We define the fundamental edge and vertex model:
...
odevertex = VertexModel(; f=diffusion_vertex!, dim=1, g=1, indim=1)
staticedge = EdgeModel(; g=AntiSymmetric(diffusion_edge!), outdim=1, indim=1)
...
odeedge = EdgeModel(; f=real_ode_edge!, dim=2, g=Fiducial(2,1), mass_matrix=0)
